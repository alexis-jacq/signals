...
class story:
	def __init__(self):
		...
		if self.Ba in ["spam"]:
			self.phrase1 = ":. ''No more "+self.Pp+" dare to check his mails since every minute, a team of "+self.BGd+" arises and finds a way to "+self.Ba+" in mass the poor passing "+self.Pp+"."
